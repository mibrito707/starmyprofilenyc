...
<div class="napoli-wrapper">
    <div class="container">
        <div class="row">
            <?php if(cs_get_option('layout_option') == 'left'): ?>
            <div class="col-md-3">
                <?php get_sidebar(); ?>
            </div>
            <?php endif; ?>
            <div class="<?php if(cs_get_option('layout_option') != 'full' || cs_get_option('layout_option') == null ):?>col-md-9<?php else:?>col-md-12<?php endif;?> col-xs-12">
            ...
            <?php if(cs_get_option('layout_option') == 'right' || cs_get_option('layout_option') == null) : ?>
                <div class="col-md-3">
                    <?php get_sidebar(); ?>
                </div>
            <?php endif; ?>
